...
function ee(e) {
  ...
  let t = /%25|%5C/gi,
    ...
    i;
  for (; (i = t.exec(e)) !== null;)
    ((r += C(e.slice(n, i.index)) + i[0]), (n = t.lastIndex));
  r += C(n ? e.slice(n) : e);
  let a = !1;
  return (
...
function re(e, t, n, r, i) {
  ...
  return (
    o ||
      ((o = B(`/`)),
      L(t, new Uint16Array(6), { from: e }, 1, o, 0),
...
function ie(e, t, n = !1) {
  ...
  return (a && (a.branch = ce(a.route)), t.matchCache.set(r, a), a);
}
function ae(e) {
...
function ue(e, t, n, r) {
  ...
  for (; c.length;) {
    ...
    if (i.kind === 2 && i.route && !G(u, n)) continue;
    if (i.parse) {
      if (!W(e, t, n)) continue;
      ((_ = n.rawParams), (g = n.extract));
    }
    r && i.route && i.kind !== N && G(l, n) && (l = n);
    let v = a === s;
    if (
      v &&
      (i.route && (!o || i.kind === N || i.kind === 2) && G(u, n) && (u = n),
    ...
    if (v && i.index) {
      let n = {
        ...
        r = !0;
      if ((i.index.parse && (W(e, t, n) || (r = !1)), r)) {
...
function _e({ path: e, params: t, decoder: n, ...r }) {
  let i = !1,
    a = Object.create(null);
  if (!e || e === `/`)
...
var $ = e(r(), 1),
  we = $.use,
  Te = typeof window < `u` ? $.useLayoutEffect : $.useEffect;
function Ee(e) {
...
var ke = t((e) => {
  ...
  je = Ae();
function Me({ children: e, fallback: t = null }) {
  return Ne()
    ? (0, je.jsx)($.Fragment, { children: e })
    : (0, je.jsx)($.Fragment, { children: t });
}
function Ne() {
...
function He(e, t, n = Ve) {
  ...
  return (0, Be.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
export {
  ie as A,
  _ as B,
