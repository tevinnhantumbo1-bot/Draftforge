//#region node_modules/.nitro/vite/services/ssr/assets/pricing-iHp73A5v.js
var SUBSCRIPTION_PLANS = [
	{
		...
		priceMonthly: 0,
		priceAnnual: 0,
		description: "Great for testing AI CAD prompts and viewing 2D/3D concept renders.",
		cadQuotaPerDay: 2,
		features: [
	...
	},
	{
		...
		priceMonthly: 20,
		priceAnnual: 20,
		description: "Get 3 extra daily requests (total 5 requests/day) for 1 full week via Base Wallet & USDC.",
		cadQuotaPerDay: 5,
		features: [
	...
	},
	{
		...
		priceMonthly: 29,
		priceAnnual: 24,
		description: "For architects, engineers & designers who draft regular CAD concepts.",
		cadQuotaPerDay: 50,
		features: [
	...
	},
	{
		...
		priceMonthly: 89,
		priceAnnual: 75,
		description: "For teams, engineering shops & agencies needing full CAD output.",
...
function quoteCents(pkg, category, briefLength) {
...
//#endregion
export { CATEGORIES, PACKAGES, SUBSCRIPTION_PLANS, formatMoney, quoteCents };
